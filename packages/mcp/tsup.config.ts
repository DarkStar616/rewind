...
// build-engine, durable stores, savings) are bundled in; the runtime deps `@rewind/core`,
// `@rewind/gateway`, `@modelcontextprotocol/sdk` and `zod` (all package.json dependencies) are
